...
def main():
    ...
    data_selection = st.radio("Choose a dataset:",["Competitor Data", "Complexes Data", "Doubles Data"], horizontal=True) # Data Selection in single row
    ...
    if data_selection == "Competitor Data":
        ...
        col1, col2 = st.columns(2)
        total_venues = selected_df["venue_id"].nunique()
        ...
        if selected_competitor != "Select Competitor":
            ...
            if not competitor_details.empty:
                ...
                st.table(competitor_details[["S.No","ranks", "movement", "competitions_played", "country"]])
            else:
        ...
        col_leaderboard1.dataframe(top_ranked[["S.No","competitor_name", "ranks"]])
        ...
        col_leaderboard2.dataframe(highest_points_df[["S.No","competitor_name", "points"]])

    conn.close()


if __name__ == "__main__":
    load_data_to_mysql()  # Load data into MySQL
    main()
